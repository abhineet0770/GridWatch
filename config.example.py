...
# Name or ID of the docker container to run capture inside of
CAPTURE_CONTAINER = "plc"
# Network interface inside the capture container namespace to sniff on
CONTAINER_CAPTURE_INTERFACE = "eth1"
